...
# 1. Create an experiment. The project name is used to determine the table name of the corresponding SQL table. All experiments of the same project will be stored in the same table.
experiment = Experiment(project_name='hello_world_project')

# 2. Configure parameters of the project such as dataset name, or learning rate. Each parameter will be stored in an SQL column in the project's SQL table. The columns is created automatically and type of the column is determined based on the type of the value of the parameter. 
...
for seed in range(0, experiment.parameters['num_runs']):
	...
	# 4. Save parameters and corresponding results to the database.
